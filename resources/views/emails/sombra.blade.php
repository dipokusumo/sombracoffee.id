            ...
            <tr>
              <td style="padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;">
                <a href="http://www.example.com/" style="text-decoration:none;">
                  <img src="https://sombracoffee.id/image/LOGO_SOMBRA.png" width="165" alt="Logo" style="width:165px;max-width:80%;height:auto;border:none;text-decoration:none;color:#ffffff;">
            ...
            <tr>
              <td style="padding:30px;background-color:#ffffff;">
                ...
                <p style="margin:0;">
                  ...
                  <br>
                  <br>Nama = {{$name}}
                  <br>Email = <a href="mailto:{{$email}}" target="_blank">{{$email}}</a><br><br>
                </p>
