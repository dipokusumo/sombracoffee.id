...
<li class="nav-item">
    <p style="padding-left: 10px;padding-top: 10px;">
        <a href="{{ route('sombra') }}" style="text-decoration: none; color: black; font-family: 'Alatsi', sans-serif; font-size: 20px; color: #f05825;">IN</a>
        <span style="font-family: 'Alatsi', sans-serif;">/</span>
        <a href="{{ route('sombra_en') }}" style="text-decoration: none; color: black; font-family: 'Alatsi', sans-serif; font-size: 20px; ">EN</a>
    </p>
</li>
@endsection
...
<section class="Product List">
    <div class="container">
                ...
                <div class = containerz>
                    <div class = cardz>
                      <div class = imagez style="text-align: center">
                        ...
                        <h6 style="padding-top: 15px;"><b>{{ $p->pname }}</b></h6>
                      </div>
                      <div class = contentz>

                        <p style="font-size: 16px;">{{ substr($p->description, 0, 100) }}</p>
                      </div>
                    </div>
                  </div>
                </a>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-4">
                <a href="{{ route('product_roastery', $p->pname_slug) }}" style="text-decoration: none; color: black">
                <div class = containerz>
                    <div class = cardz>
                      <div class = imagez style="text-align: center">
                      ...
                      <div class = contentz>
                        <p style="font-size: 16px;">{{ substr($p->description, 0, 80) . "..." }}</p>
                      </div>
                    </div>
                  </div>
                </a>
