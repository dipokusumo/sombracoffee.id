...
<div class="Address" style="padding-bottom: 30px; padding-top: 30px;">
    <div class="container">
      <div class="row">
        <div class="col-sm-4">
            <a href="{{ route('product') }}" style="text-decoration: none; color: black;"><i style="position: absolute; left: 40px; bottom: 495px;" class="fas fa-reply" style="position: absolute; left: 40px; bottom : 20px;"></i></a>
        ...
        <div class="col-sm-8">
            <div class="card" style="width: 100%; padding: 20px; filter: drop-shadow(-1px 1px 1px black);">
                <h4 style="font-weight: bolder;">{{ $r->pname }}</h4>
                {!! $r->specification !!}
            </div>
            <hr>
            <div class="card" style="width: 100%; padding: 20px; filter: drop-shadow(2px 2px 2px black);">
                ...
                <div style="text-align: right; padding-top: 20px;">
                    <a href="{{ $r->link_tokopedia }}" target="_blank" class="btn" style="text-align: right; background: #61bf56; color: white; font-size: 13px;">Buy by
                        TOKOPEDIA<img
                            style="filter: sepia(1) ; height: 20px; margin-bottom: 5px; margin-left: 5px;"
                            src="{{ asset('image/icon/ikon-tokopedia.png') }}"></a>
                    <a href="{{ $r->link_shopee  }}" target="_blank" class="btn" style="text-align: right; background: #f1582c; color: white; font-size: 13px;">Buy by
                        SHOPEE<img
