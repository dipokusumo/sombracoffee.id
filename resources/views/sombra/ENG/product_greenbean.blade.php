...
<div class="Address" style="padding-bottom: 30px; padding-top: 30px;">
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <a href="{{ route('product_en') }}" style="text-decoration: none; color: black;">
                    <i style="position: absolute; left: 40px; bottom: 495px;" class="fas fa-reply"
                        style="position: absolute; left: 40px; bottom : 20px;"></i>
                </a>
            ...
            <div class="col-sm-8">
                ...
                <div class="card" style="width: 100%; padding: 20px; filter: drop-shadow(-1px 1px 1px black);">
                    <h4 style="font-weight: bolder;">{{ $g->pname_eng }}</h4>
                    {!! $g->specification_eng !!}
                ...
                <div class="card" style="width: 100%; padding: 20px; filter: drop-shadow(2px 2px 2px black);">
                    ...
                    <div style="text-align: right; padding-top: 20px;">
                        <a href="{{ $g->link_tokopedia }}" target="_blank" class="btn" style="text-align: right; background: #61bf56; color: white; font-size: 13px; filter: drop-shadow(2px 1px 2px black);">Buy by
                            TOKOPEDIA<img
                        ...
                        <a href="{{ $g->link_shopee  }}" target="_blank" class="btn" style="text-align: right; background: #f1582c; color: white; font-size: 13px; filter: drop-shadow(2px 1px 2px black);">Buy by
                            SHOPEE<img
