    ...
    <nav class="main-header navbar navbar-expand navbar-dark" style="background: black;">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="{{ route('cmsSliders') }}" class="nav-link">Sliders</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('cmsProductG') }}" class="nav-link">Produk Green Bean</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('cmsProductR') }}" class="nav-link">Produk Roastery</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('cmsCoffeeShop') }}" class="nav-link">Coffee Shop</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('cmsArticle') }}" class="nav-link">Article</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('cmsContact') }}" class="nav-link">Contact</a>
          </li>
      </ul>
...
<footer class="main-footer">
  <strong>Copyright &copy; {{ date('Y') }} <a href="" style="color: black;">Sombra Coffee</a> <i><img src="{{ asset('image/icon/ikon-sombra.png') }}" style="width: 25px;"></i></strong>
</footer>
</div>
<!-- ./wrapper -->
