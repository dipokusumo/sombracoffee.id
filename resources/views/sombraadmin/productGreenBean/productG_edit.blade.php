...
<div class="content-wrapper" style="background: white;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Product GREENBEAN</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: black">Produk</a></li>
                        <li class="breadcrumb-item"><a style="color: black">GREENBEAN</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        @foreach($produkgb as $p)
        <form action="{{ route('cmsProductGUpdate') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <input type="hidden" name="id_product_greenbean" value="{{ $p->id_product_greenbean  }}">
          <div class="col-sm-12">
            <a href="{{ route('cmsProductG') }}" class="btn btn-warning btn-sm" style="margin-bottom: 5px; border-radius: 20px 1px 10px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="input-group">
                            <img src="{{ asset('img/product/greenbean/' . $p->imagep) }}" id="imagep" class="img-thumbnail" style="width: 200px;">
                            <div class="custom-file">
                            <input type="file" name="imagep" accept="image/*" class="custom-file-input" id="imagep" onchange="promoImage(event)">
                            <label class="custom-file-label" for="imagep">{{ old('imagep') ? old('imagep') : $p->imagep }}</label>
                            <input type="hidden" name="imageps" value="{{ $p->imagep }}">
                            </div>
                        </div>
                      </div>
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>pname</label>
                      <input type="text" class="form-control" placeholder="" name="pname" value="{{ old('pname') ? old('pname') : $p->pname }}" required>
                    </div>
                  </div>

                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>pname_eng</label>
                      <input type="text" class="form-control" placeholder="" name="pname_eng" value="{{ old('pname_eng') ? old('pname_eng') : $p->pname_eng }}" required>
                    </div>
                  </div>

                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>pname_sub</label>
                      <input type="text" class="form-control" placeholder="" name="pname_sub" value="{{ old('pname_sub') ? old('pname_sub') : $p->pname_sub }}">
                    </div>
                  </div>

                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>pname_sub_eng</label>
                      <input type="text" class="form-control" placeholder="" name="pname_sub_eng" value="{{ old('pname_sub_eng') ? old('pname_sub_eng') : $p->pname_sub_eng }}">
                    </div>
                  </div>

                  <div class="col-md-6">
                    <label>Specification</label>
                    <textarea id="specification" name="specification" rows="7">{{ old('specification') ? old('specification') : $p->specification }}
                    </textarea>
                  </div>
                  <div class="col-md-6">
                    <label>Specification Slide | ENG</label>
                    <textarea id="specification_eng" name="specification_eng" rows="7">{{ old('specification_eng') ? old('specification_eng') : $p->specification_eng }}
                    </textarea>
                  </div>

                  <div class="col-md-6">
                    <label>Deskripsi</label>
                    <textarea class="form-control" name="description" rows="7">{{ old('description') ? old('description') : $p->description }}</textarea>
                  </div>
                  <div class="col-md-6">
                    <label>Deskripsi | ENG</label>
                    <textarea class="form-control" name="description_eng" rows="7">{{ old('description_eng') ? old('description_eng') : $p->description_eng }}</textarea>
                  </div>

                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>link Tokopedia</label>
                      <input type="text" class="form-control" placeholder="" name="link_tokopedia" value="{{ old('link_tokopedia') ? old('link_tokopedia') : $p->link_tokopedia }}">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="link_shopee" value="{{ old('link_shopee') ? old('link_shopee') : $p->link_shopee }}">
                    </div>
                  </div>
...
<script>
    ...
    var promoImage = function(event) {
      var outputourBrands = document.getElementById('imagep');
