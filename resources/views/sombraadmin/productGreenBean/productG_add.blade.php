...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        <form action="{{ route('cmsProductGStore') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="col-sm-12">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="imagep" class="custom-file-input" id="imagep">
                        <label class="custom-file-label" for="imagep"></label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>pname</label>
                      <input type="text" class="form-control" placeholder="" name="pname" value="{{ old('pname') }}" required>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="pname_eng" value="{{ old('pname_eng') }}" required>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="pname_sub" value="{{ old('pname_sub') }}">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="pname_sub_eng" value="{{ old('pname_sub_eng') }}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <textarea class="form-control" name="description_eng" rows="7">
                      {{ old('description_eng') }}
                    </textarea>
                  </div>
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="link_tokopedia" value="{{ old('link_tokopedia') }}">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="link_shopee" value="{{ old('link_shopee') }}">
                    </div>
                  </div>
