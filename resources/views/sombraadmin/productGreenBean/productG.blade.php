...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <a href="{{ route('cmsProductGAdd') }}">
                <button type="button" class="btn" style="border-radius: 2px 0px 0px 9px; background: black; color: white;">Add Product GREENBEAN</button>
              </a>
              <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th>pname_eng | ENG</th>
                        <th>pname_sub</th>
                        <th>pname_sub_eng | ENG</th>
                        <th>specification</th>
                        <th>specification_eng | ENG</th>
                        <th>description</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $no }}</td>
                        <td><img width="144" src="{{ asset('img/product/greenbean/'. $p->imagep) }}"></td>
                        <td>{{ $p->pname }}</td>
                        <td>{{ $p->pname_eng }}</td>
                        <td>{{ $p->pname_sub }}</td>
                        <td>{{ $p->pname_sub_eng }}</td>
                        <td>{!! $p->specification !!}</td>
                        <td>{!! $p->specification_eng !!}</td>
                        <td>{!! $p->description !!}</td>
                        <td>{!! $p->description_eng !!}</td>
                        <td>{{ $p->link_tokopedia }}</td>
                        <td>{{ $p->link_shopee }}</td>
                        <td><a href="{{ route('cmsProductGEdit', $p->id_product_greenbean) }}" type="button" class="btn btn-info btn-sm">Edit</a> | <a href="{{ route('cmsProductGDelete', $p->id_product_greenbean) }}" type="button" class="btn btn-danger btn-sm">Delete</a></td>
                        {{-- <td><a href="{{ route('cultureedit' , $c->id_culture) }}" type="button" class="btn btn-info btn-sm">Edit</a> | <a href="{{ route('culturedelete' , $c->id_culture) }}" type="button" class="btn btn-danger btn-sm">Delete</a></td> --}}
                      </tr>
                      <?php $no++ ?>
                      @endforeach
                    </tbody>
