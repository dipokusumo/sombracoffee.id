...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        <form action="{{ route('cmsDescGreenBeanStore') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="col-sm-12">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <textarea class="form-control" name="description_eng" rows="7">{{ old('description_eng') }}</textarea>
                  </div>
