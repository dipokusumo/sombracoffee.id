...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        <form action="{{ route('cmsSlidersStore') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="col-sm-12">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="judul1" value="{{ old('judul1') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Judul Slide 1 | ENG</label>
                      <input type="text" class="form-control" placeholder="" name="judul1_eng" value="{{ old('judul1_eng') }}" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    ...
                    <textarea id="description1_eng" name="description1_eng" rows="7">
                      {{ old('description1_eng') }}
                    </textarea>
                  </div>
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Link 1 Button Name</label>
                      <input type="text" class="form-control" placeholder="" name="link1_name" value="{{ old('link1_name') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Link 1 Button Name Eng</label>
                      <input type="text" class="form-control" placeholder="" name="link1_name_eng" value="{{ old('link1_name_eng') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-12" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Link 1</label>
                      <input type="text" class="form-control" placeholder="" name="link1" value="{{ old('link1') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-12" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Link 1 | ENG</label>
                      <input type="text" class="form-control" placeholder="" name="link1_eng" value="{{ old('link1_eng') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Judul Slide 2</label>
                      <input type="text" class="form-control" placeholder="" name="judul2" value="{{ old('judul2') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Judul Slide 2 | ENG</label>
                      <input type="text" class="form-control" placeholder="" name="judul2_eng" value="{{ old('judul2_eng') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Deskripsi Slide 2</label>
                      <textarea id="description2" name="description2" style="padding-bottom: 60px">
                        {{ old('description2') }}
                      </textarea>
                    </div>
                  </div>
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Deskripsi Slide 2 | ENG</label>
                      <textarea id="description2_eng" name="description2_eng" style="padding-bottom: 60px">
                        {{ old('description2_eng') }}
                      </textarea>
                    </div>
                  </div>
                  <div class="col-sm-12" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="link2_name" value="{{ old('link2_name') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-12" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Link 2 Button Name ENG</label>
                      <input type="text" class="form-control" placeholder="" name="link2_name_eng" value="{{ old('link2_name_eng') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-12" style="margin-top: 10px">
                    <div class="form-group">
                      <label>link 2</label>
                      <input type="text" class="form-control" placeholder="" name="link2" value="{{ old('link2') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-12" style="margin-top: 10px">
                    <div class="form-group">
                      <label>link 2 | ENG</label>
                      <input type="text" class="form-control" placeholder="" name="link2_eng" value="{{ old('link2_eng') }}" required>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="judul3" value="{{ old('judul3') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Judul Slide 3 | ENG</label>
                      <input type="text" class="form-control" placeholder="" name="judul3_eng" value="{{ old('judul3_eng') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Deskripsi Slide 3</label>
                      <textarea id="description3" name="description3" style="padding-bottom: 60px">
                        {{ old('description3') }}
                      </textarea>
                    </div>
                  </div>
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Deskripsi Slide 3 | ENG</label>
                      <textarea id="description3_eng" name="description3_eng" style="padding-bottom: 60px">
                        {{ old('description3_eng') }}
                      </textarea>
                    </div>
                  </div>
                  <div class="col-sm-12" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="link3_name" value="{{ old('link3_name') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-12" style="margin-top: 10px">
                    <div class="form-group">
                      <label>Link 3 Button Name ENG</label>
                      <input type="text" class="form-control" placeholder="" name="link3_name_eng" value="{{ old('link3_name_eng') }}" required>
                    </div>
                  </div>
                  <div class="col-sm-12" style="margin-top: 10px">
                    <div class="form-group">
                      <label>link 3</label>
                      <input type="text" class="form-control" placeholder="" name="link3" value="{{ old('link3') }}" required>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-12" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="link3_eng" value="{{ old('link3_eng') }}" required>
                    </div>
                  </div>
