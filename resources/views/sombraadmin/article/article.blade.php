...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <a href="{{ route('cmsArticleAdd') }}">
                <button type="button" class="btn" style="border-radius: 2px 0px 0px 9px; background: black; color: white;">Add Article</button>
              </a>
              <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $no }}</td>
                        <td><img width="144" src="{{ asset('img/article/'. $a->image) }}"></td>
                        <td>{{ $a->judul }}</td>
                        <td>{{ $a->judul_eng }}</td>
                        <td>{!! $a->description_sub !!}</td>
                        <td>{!! $a->description_sub_eng !!}</td>
                        <td>{!! $a->description !!}</td>
                        <td>{!! $a->description_eng !!}</td>
                        <td><a href="{{ route('cmsArticleEdit', $a->id_article) }}" type="button" class="btn btn-info btn-sm">Edit</a> | <a href="{{ route('cmsArticleDelete', $a->id_article) }}" type="button" class="btn btn-danger btn-sm">Delete</a></td>
