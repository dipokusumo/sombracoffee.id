...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        ...
        <form action="{{ route('cmsArticleUpdate') }}" method="POST" enctype="multipart/form-data">
          @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="input-group">
                            <img src="{{ asset('img/article/' . $a->image) }}" id="image" class="img-thumbnail" style="width: 200px;">
                            <div class="custom-file">
                            <input type="file" name="image" accept="image/*" class="custom-file-input" id="image" onchange="promoImage(event)">
                            <label class="custom-file-label" for="image">{{ old('image') ? old('image') : $a->image }}</label>
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      <label>judul</label>
                      <input type="text" class="form-control" placeholder="" name="judul" value="{{ old('judul') ? old('judul') : $a->judul }}" required>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="judul_eng" value="{{ old('judul_eng') ? old('judul_eng') : $a->judul_eng }}" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <textarea id="description_sub" name="description_sub" rows="7">
                        {{ old('description_sub') ? old('description_sub') : $a->description_sub }}
                    </textarea>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <textarea id="description_sub_eng" name="description_sub_eng" rows="7">
                        {{ old('description_sub_eng') ? old('description_sub_eng') : $a->description_sub_eng }}
                    </textarea>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <textarea id="description" name="description" rows="7">
                        {{ old('description') ? old('description') : $a->description }}
                    </textarea>
                  </div>
                  <div class="col-md-6">
                    <label>Deskripsi | ENG</label>
                    <textarea id="description_eng" name="description_eng" rows="7">
                        {{ old('description_eng') ? old('description_eng') : $a->description_eng }}
                    </textarea>
                  </div>
