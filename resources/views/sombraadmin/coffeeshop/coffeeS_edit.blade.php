...
<div class="content-wrapper" style="background: white;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Coffee Shop</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: black">Chart</a></li>
                        <li class="breadcrumb-item active" style="color: #a38b0c">Edit Coffee Shop</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <form action="{{ route('cmsCoffeeShopUpdate') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <input type="hidden" name="id_coffee_shop" value="{{ $c->id_coffee_shop }}">
          <div class="col-sm-12">
            <a href="{{ route('cmsCoffeeShop') }}" class="btn btn-warning btn-sm" style="margin-bottom: 5px; border-radius: 20px 1px 10px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="input-group">
                            <img src="{{ asset('img/coffeeshop/' . $c->imagecs) }}" id="imagecs" class="img-thumbnail" style="width: 200px;">
                            <div class="custom-file">
                            <input type="file" name="imagecs" accept="image/*" class="custom-file-input" id="imagecs" onchange="promoImage(event)">
                            <label class="custom-file-label" for="imagecs">{{ old('imagecs') ? old('imagecs') : $c->imagecs }}</label>
                            <input type="hidden" name="imagecss" value="{{ $c->imagecs }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12" style="margin-top: 10px">
                        <div class="form-group">
                          <label>Nama</label>
                          <input type="text" class="form-control"  name="nama" value="{{ old('nama') ? old('nama') : $c->nama }}" required>
                        </div>
                    </div>
...
<script>
    ...
    var promoImage = function(event) {
      var outputourBrands = document.getElementById('imagecs');
