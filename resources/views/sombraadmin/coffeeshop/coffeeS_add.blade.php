...
<div class="content-wrapper" style="background: white;">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active" style="color: #a38b0c">Add Coffee Shop</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <form action="{{ route('cmsCoffeeShopStore') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="col-sm-12">
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="imagecs" class="custom-file-input" id="imagecs">
                        <label class="custom-file-label" for="imagecs"></label>
                      </div>
                    </div>
                  </div>
