...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Produk Sliders GREENBEAN</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: black">Produk</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <a href="{{ route('cmsSlidersGreenBeanAdd') }}">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $no }}</td>
                        <td><img width="144" src="{{ asset('img/slidersGreenBean/'. $s->imagesg) }}"></td>
                        {{-- <td><img width="144" src="{{ asset('img/slidersGreenBean/en/'. $s->image) }}"></td> --}}

                        <td><a href="{{ route('cmsSlidersGreenBeanEdit', $s->id) }}" type="button" class="btn btn-info btn-sm">Edit</a> | <a href="{{ route('cmsSlidersGreenBeanDelete', $s->id) }}" type="button" class="btn btn-danger btn-sm">Delete</a></td>
