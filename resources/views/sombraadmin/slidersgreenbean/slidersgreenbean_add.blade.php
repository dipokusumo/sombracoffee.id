...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Add Sliders Product GREENBEAN</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: black">Produk</a></li>
    ...
    <section class="content">
        <form action="{{ route('cmsSlidersGreenBeanStore') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="col-sm-12">
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="imagesg" class="custom-file-input" id="imagesg">
                        <label class="custom-file-label" for="imagesg"></label>
                      </div>
                    </div>
