...
@section('title', 'Sliders GreenBean')
@section('css')
<style>
  .info{
    margin-top: 10px;
...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Sliders Product GREENBEAN</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: black">Produk</a></li>
    ...
    <section class="content">
        ...
        <form action="{{ route('cmsSlidersGreenBeanUpdate') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <input type="hidden" name="id" value="{{ $s->id  }}">
          <div class="col-sm-12">
            <a href="{{ route('cmsSlidersGreenBean') }}" class="btn btn-warning btn-sm" style="margin-bottom: 5px; border-radius: 20px 1px 10px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="input-group">
                            <img src="{{ asset('img/slidersGreenBean/' . $s->imagesg) }}" id="imagesg" class="img-thumbnail" style="width: 200px;">
                            <div class="custom-file">
                            <input type="file" name="imagesg" accept="imagesg/*" class="custom-file-input" id="imagesg" onchange="promoImage(event)">
                            <label class="custom-file-label" for="imagesg">{{ old('imagesg') ? old('imagesg') : $s->imagesg }}</label>
                            <input type="hidden" name="imagesgs" value="{{ $s->imagesg }}">
                            </div>
                        </div>
                        <span style="color:red;">*</span> <span style="font-size: 12px;"><i>Req Image <b>1981 x 909</b></i></span>
                      </div>
...
<script>
  ...
  var promoImage = function(event) {
      var outputourBrands = document.getElementById('imagesg');
