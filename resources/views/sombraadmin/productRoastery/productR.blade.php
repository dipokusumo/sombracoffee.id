...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <a href="{{ route('cmsProductRAdd') }}">
                <button type="button" class="btn" style="border-radius: 2px 0px 0px 9px; background: black; color: white;">Add Product Roastery</button>
              </a>
              <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php $no = 1 ?>
                      @foreach($produkr as $p)
                      <tr>
                        <td>{{ $no }}</td>
                        <td><img width="144" src="{{ asset('img/product/roastery/'. $p->imagep) }}"></td>
                        <td>{{ $p->pname }}</td>
                        <td>{{ $p->pname_eng }}</td>
                        ...
                        <td>{{ $p->link_shopee }}</td>
                        <td><a href="{{ route('cmsProductREdit', $p->id_product_roastery) }}" type="button" class="btn btn-info btn-sm">Edit</a> | <a href="{{ route('cmsProductRDelete', $p->id_product_roastery) }}" type="button" class="btn btn-danger btn-sm">Delete</a></td>
