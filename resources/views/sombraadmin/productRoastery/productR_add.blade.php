...
<div class="content-wrapper" style="background: white;">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active" style="color: #a38b0c">Add Roastery</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <form action="{{ route('cmsProductRStore') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="col-sm-12">
            <a href="{{ route('cmsProductR') }}" class="btn btn-warning btn-sm" style="margin-bottom: 5px; border-radius: 20px 1px 10px;">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="pname_eng" value="{{ old('pname_eng') }}">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6" style="margin-top: 10px">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="pname_eng_sub" value="{{ old('pname_sub_eng') }}">
                    </div>
                  </div>
