...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        ...
        <form action="{{ route('cmsProductRUpdate') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id_product_roastery" value="{{ $p->id_product_roastery }}">
            <div class="col-sm-12">
                <a href="{{ route('cmsProductR') }}" class="btn btn-warning btn-sm"
                    style="margin-bottom: 5px; border-radius: 20px 1px 10px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="input-group">
                                    <img src="{{ asset('img/product/roastery/' . $p->imagep) }}" id="imagep"
                                        class="img-thumbnail" style="width: 200px;">
                                    <div class="custom-file">
                                        <input type="file" name="imagep" accept="image/*" class="custom-file-input"
                                            id="imagep" onchange="promoImage(event)">
                                        <label class="custom-file-label" for="imagep">{{ old('imagep') ? old('imagep') :
                                            $p->imagep }}</label>
                            ...
                            <div class="col-sm-6" style="margin-top: 10px">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="pname"
                                        value="{{ old('pname') ? old('pname') : $p->pname }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6" style="margin-top: 10px">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="pname_eng"
                                        value="{{ old('pname_eng') ? old('pname_eng') : $p->pname_eng }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6" style="margin-top: 10px">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="pname_sub"
                                        value="{{ old('pname_sub') ? old('pname_sub') : $p->pname_sub }}" >
                                </div>
                            </div>

                            <div class="col-sm-6" style="margin-top: 10px">
                                <div class="form-group">
                                    <label>pname_eng_sub</label>
                                    <input type="text" class="form-control" placeholder="" name="pname_eng_sub"
                                        value="{{ old('pname_eng_sub') ? old('pname_eng_sub') : $p->pname_eng_sub }}">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <label>Specification</label>
                                <textarea id="specification" name="specification" rows="7">
                        {{ old('specification') ? old('specification') : $p->specification }}
                    </textarea>
                            </div>
                            <div class="col-md-6">
                                <label>Specification | ENG</label>
                                <textarea id="specification_eng" name="specification_eng" rows="7">
                        {{ old('specification_eng') ? old('specification_eng') : $p->specification_eng }}
                    </textarea>
                            </div>
                            ...
                            <div class="col-sm-6" style="margin-top: 10px">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="link_tokopedia"
                                        value="{{ old('link_tokopedia') ? old('link_tokopedia') : $p->link_tokopedia }}"
                                        >
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6" style="margin-top: 10px">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="link_shopee"
                                        value="{{ old('link_shopee') ? old('link_shopee') : $p->link_shopee }}"
                                        >
                                </div>
                            </div>
