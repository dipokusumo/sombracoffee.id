...
<div class="content-wrapper" style="background: white;">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active" style="color: #a38b0c">Coffee Outlet</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <a href="{{ route('cmsCoffeeOutletAdd') }}">
                <button type="button" class="btn" style="border-radius: 2px 0px 0px 9px; background: black; color: white;">Add Coffee Outlet </button>
              </a>
              <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $no }}</td>
                        <td><img width="144" src="{{ asset('img/coffeeoutlet/'. $c->imageco) }}"></td>
                        <td><a href="{{ route('cmsCoffeeOutletEdit', $c->id_coffee_outlet ) }}" type="button" class="btn btn-info btn-sm">Edit</a> | <a href="{{ route('cmsCoffeeOutletDelete', $c->id_coffee_outlet) }}" type="button" class="btn btn-danger btn-sm">Delete</a></td>
