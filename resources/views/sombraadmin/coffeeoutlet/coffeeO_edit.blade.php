...
<div class="content-wrapper" style="background: white;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Coffee Outlet</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: black">Chart</a></li>
                        <li class="breadcrumb-item active" style="color: #a38b0c">Edit Coffee Outlet</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        @foreach($coffeeoutlet as $c)
        <form action="{{ route('cmsCoffeeOutletUpdate') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <input type="hidden" name="id_coffee_outlet" value="{{ $c->id_coffee_outlet }}">
          <div class="col-sm-12">
            <a href="{{ route('cmsCoffeeOutlet') }}" class="btn btn-warning btn-sm" style="margin-bottom: 5px; border-radius: 20px 1px 10px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="input-group">
                            <img src="{{ asset('img/coffeeoutlet/' . $c->imageco) }}" id="imageco" class="img-thumbnail" style="width: 200px;">
                            <div class="custom-file">
                            <input type="file" name="imageco" accept="image/*" class="custom-file-input" id="imagecs" onchange="promoImage(event)">
                            <label class="custom-file-label" for="imageco">{{ old('imageco') ? old('imageco') : $c->imageco }}</label>
                            <input type="hidden" name="imagecos" value="{{ $c->imageco }}">
                            </div>
                        </div>
                      </div>
