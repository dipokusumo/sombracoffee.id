...
<div class="content-wrapper" style="background: white;">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active" style="color: #a38b0c">Add Coffee Outlet</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <form action="{{ route('cmsCoffeeOutletStore') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-sm-12">
                <a href="{{ route('cmsCoffeeOutlet') }}" class="btn btn-warning btn-sm"
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="imageco" class="custom-file-input" id="imageco">
                                        <label class="custom-file-label" for="imageco"></label>
                                    </div>
                                </div>
                            </div>
