...
<div class="content-wrapper" style="background: white;">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a style="color: black">Desc</a></li>
                        <li class="breadcrumb-item active" style="color: #a38b0c">Edit Roastery</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        @foreach($descR as $d)
        <form action="{{ route('cmsDescRoasteryUpdate') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <input type="hidden" name="id" value="{{ $d->id  }}">
          <div class="col-sm-12">
            <a href="{{ route('cmsDescRoastery') }}" class="btn btn-warning btn-sm" style="margin-bottom: 5px; border-radius: 20px 1px 10px;">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <textarea class="form-control" name="description" rows="7">{{ old('description') ? old('description') : $d->description }}</textarea>
                  </div>
                  <div class="col-md-6">
                    <label>Deskripsi | ENG</label>
                    <textarea class="form-control" name="description_eng" rows="7">{{ old('description_eng') ? old('description_eng') : $d->description_eng }}</textarea>
                  </div>
