...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        <form action="{{ route('cmsSlidersRoasteryStore') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="col-sm-12">
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="imagesr" class="custom-file-input" id="imagesr">
                        <label class="custom-file-label" for="imagesr"></label>
                      </div>
                    </div>
