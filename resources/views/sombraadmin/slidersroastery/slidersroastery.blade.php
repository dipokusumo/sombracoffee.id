...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <a href="{{ route('cmsSlidersRoasteryAdd') }}">
                <button type="button" class="btn" style="border-radius: 2px 0px 0px 9px; background: black; color: white;">Add Sliders Roastery</button>
              </a>
              <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $no }}</td>
                        <td><img width="144" src="{{ asset('img/slidersRoastery/'. $s->imagesr) }}"></td>
                        {{-- <td><img width="144" src="{{ asset('img/slidersGreenBean/en/'. $s->image) }}"></td> --}}

                        <td><a href="{{ route('cmsSlidersRoasteryEdit', $s->id) }}" type="button" class="btn btn-info btn-sm">Edit</a> | <a href="{{ route('cmsSlidersRoasteryDelete', $s->id) }}" type="button" class="btn btn-danger btn-sm">Delete</a></td>
